...
const VALID_KEYS = ["cc-planning", "cc-schedules", "cc-memos", "cc-memos-v2", "cc-custom-keys", "cc-custom-tickets", "cc-planning-notes", "cc-ticket-notes", "cc-etr", "cc-agenda", "cc-hidden-keys", "cc-hidden-meta", "cc-ticket-added-dates", "cc-roadmap-initiatives", "cc-weekly-notes", "cc-update-candidates", "cc-weekly-sync-meta", "cc-jira-filters", "cc-filter-tickets", "cc-ticket-sources", "cc-weekly-source-text", "cc-planning-priorities", "cc-execution-priorities", "cc-etr-status-commented", "cc-remote-links-cache", "cc-confluence-page-cache", "cc-ticket-outcomes"] as const;
