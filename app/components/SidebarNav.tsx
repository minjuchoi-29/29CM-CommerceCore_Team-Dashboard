    ...
    >
      ...
      <div className="px-3 pt-3 pb-2">
        ...
        <div className="flex flex-col gap-0.5">
          ...
          {/* 위클리 작성 가이드 — /weekly-guide 페이지 (사용 가이드/퀵 링크는 모달, 본 항목은 페이지 라우팅) */}
          <Link
            href="/weekly-guide"
            className="flex items-center gap-2.5 px-2.5 py-2 rounded-md text-xs font-medium transition-all"
            style={{
              color: isActive("/weekly-guide") ? "#818cf8" : "var(--text-muted)",
              background: isActive("/weekly-guide") ? "var(--bg-item)" : "transparent",
              borderLeft: `2px solid ${isActive("/weekly-guide") ? "#818cf8" : "transparent"}`,
            }}
            onMouseEnter={e => {
              if (isActive("/weekly-guide")) return;
              (e.currentTarget as HTMLElement).style.background = "var(--bg-item)";
          ...
          >
            ...
            <span className="flex-1">위클리 작성 가이드</span>
          </Link>
